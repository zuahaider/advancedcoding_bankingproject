...
# Deposit is a child class that inherits from the parent class AccountAction.
class Deposit(AccountAction):
    def __init__(self, account_no, amount):
        # Initialize the parent class with account number.
        super().__init__(account_no)
        self.amount = amount

    def execute(self):
        # Implementations for depositing money
